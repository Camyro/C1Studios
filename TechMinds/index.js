...
setInterval(function() {
  ...
  //Calcular
  var total = inicio + (nLadrilhoDePrimeira * 5) + (nladrilhoDeSegunda * 3) + nladrilhoDeTerceira + (nBecoESaida * 10) + (nGangorra * 20) + (nobstaculo * 20) + (ngap * 10) + (nrampa * 10) + (nlombada * 10) + (final - (5 * ntentativas));
  total = total * GG;
  total = total * GG2;
  total = total * GR;
  total = total * RG;
